...
一个非官方、非商业的雪之下雪乃风格 Codex v2 动态宠物项目。它采用正常动漫人体比例与 galgame 式表演，但把事件动作改成在原生尺寸下一眼能懂的全身姿态：举手致意、脸红并左右抬手制止、低头垂肩失败、蹲下托掌等待、弯腰检查，以及叉臂举起✌️完成。
...
- 悬停采用五阶段站立拒触：胸前蓄势、左侧抬手制止、中间收臂、右侧抬手制止、回到胸前蓄势；首尾都接近待机站姿。
- 原生桌面端会把非待机动作固定播放三遍；macOS 26.721.41059 可使用仓库内的版本锁定补丁改为单次播放并将帧时长放慢 2 倍。
- 事件语义主要由举手、左右制止手势、低头垂肩、蹲下托掌、弯腰和叉臂✌️等全身轮廓表达，而不是依赖难以辨认的微表情。
...
| 鼠标进入宠物区域 | `jumping / hover` | 从胸前蓄势依次做左侧制止、收臂、右侧制止，再平滑回到站立蓄势。 |
